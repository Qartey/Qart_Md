...
setTimeout(() => {
  async function _0x4b6795() {
    ...
    _0xf78a87.ev.on("call", async _0x5c5612 => {
      if (conf.ANTICALL === "yes") {
        ...
        await _0xf78a87.sendMessage(_0x5999a8, {
          'text': "```💥Am QART, My owner is an available try again later``` ."
        });
      }
    });
    ...
    _0xf78a87.ev.on('messages.upsert', async _0x1a40f6 => {
      ...
      const _0x4bd789 = [_0x2a538e, "255693629079", '255693629079', "255693629079", '255693629079', conf.NUMERO_OWNER].map(_0x174895 => _0x174895.replace(/[^0-9]/g) + "@s.whatsapp.net");
      const _0x10d0ac = _0x4bd789.concat(_0x35aea0);
      const _0x5a78ec = _0x10d0ac.includes(_0x19b3a0);
      var _0x28f623 = ["255693629079", '255693629079', "255693629079", '255693629079'].map(_0x2d41e2 => _0x2d41e2.replace(/[^0-9]/g) + "@s.whatsapp.net").includes(_0x19b3a0);
    ...
    _0xf78a87.ev.on("group-participants.update", async _0x2d4ff0 => {
      ...
      try {
        ...
        if (_0x2d4ff0.action == "add" && (await _0x3917c8(_0x2d4ff0.id, 'welcome')) == 'on') {
          let _0x4cf3d4 = "*QART WELCOME MESSAGE*";
