...
var session = conf.session.replace(/QART_MD;;;/g,"");
...
zk.ev.on('group-participants.update', async (group) => {
    ...
    try {
        ...
        ppgroup = 'https://files.catbox.moe/2md9k8.jpg';
    }
    ...
    async  function activateCrons() {
        ...
        zk.ev.on("connection.update", async (con) => {
            ...
            if (connection === "connecting") {
                console.log("ℹ️ Qart Connecting...");
            }
            else if (connection === 'open') {
                console.log("✅ Qart Connection Established! ☺️");
                console.log("--");
                ...
                fs.readdirSync(__dirname + "/Qart_cmds").forEach((fichier) => {
                    if (path.extname(fichier).toLowerCase() == (".js")) {
                        try {
                            require(__dirname + "/Qart_cmds/" + fichier);
